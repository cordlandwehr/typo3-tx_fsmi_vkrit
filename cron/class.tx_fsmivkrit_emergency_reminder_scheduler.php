...
class tx_fsmivkrit_emergency_reminder_scheduler 
...
'=============='."\n\n";
		...
		$lecturesWithoutKritter = $this->lecturesWithoutKritter($survey,2);
...
'--------------'."\n";
		...
		// state problems first
		$lecturesAll = $this->lecturesInNextDays($survey,2);
		$none=true;
		$fullMail .=
