...
/**
 * Aditional fields provider class for reminder schedular for the vkrit-tool
 *
 * @author		Andreas Cord-Landwehr <cola@uni-paderborn.de>
 * @package		fsmi_vkrit
 */
class tx_fsmivkrit_reminder_organizer_scheduler_AdditionalFieldProvider implements tx_scheduler_AdditionalFieldProvider {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fsmi_vkrit/cron/class.tx_fsmivkrit_reminder_organizer_scheduler_additionalfieldprovider.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/fsmi_vkrit/cron/class.tx_fsmivkrit_reminder_organizer_scheduler_additionalfieldprovider.php']);
}
